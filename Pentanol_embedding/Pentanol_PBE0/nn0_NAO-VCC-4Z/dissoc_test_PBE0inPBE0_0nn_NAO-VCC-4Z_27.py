...
pentanol_dimer = read('pentanol_molecules.xyz', index=27)
os.environ['AIMS_SPECIES_DIR'] = "/work/e05/e05/gabram/FHIaims/species_defaults/NAO-VCC-nZ//NAO-VCC-4Z"
run_single_fragment_full_molecule(pentanol_dimer, hl_calc=calc_hl, ll_calc=calc_ll, hl_xc="PBE0", ll_xc="PBE0", post_hf_method=None, basis="NAO-VCC-4Z", run_dir="nn0_NAO-VCC-4Z")
