...
pentanol_monomer = read('pentanol_monomer.xyz')
region2 = [5, 17]
embed_mask = [2]*len(pentanol_monomer)
for atom_idx in region2:
    embed_mask[atom_idx] = 1
os.environ['AIMS_SPECIES_DIR'] = "/work/e05/e05/gabram/FHIaims/species_defaults/NAO-VCC-nZ//NAO-VCC-4Z"
run_single_fragment_full_molecule(pentanol_monomer, embed_mask=embed_mask, hl_calc=calc_hl, ll_calc=calc_ll, hl_xc="PBE0", ll_xc="PBE", post_hf_method=None, basis="NAO-VCC-4Z", run_dir="nn0_NAO-VCC-4Z")
