...
run_single_fragment(pentanol_dimer, embed_mask=embed_mask, hl_calc=calc_hl, ll_calc=calc_ll, hl_xc="PBE0", ll_xc="PBE", post_hf_method=None, basis="NAO-VCC-4Z", run_dir="nn4_NAO-VCC-4Z")
