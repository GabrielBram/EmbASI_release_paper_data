...
#run_single_fragment_and_print(pentanol, embed_mask=mono_embed_mask, hl_calc=calc_hl, ll_calc=calc_ll, hl_xc="PBE0", ll_xc="PBE0", post_hf_method="rpa", basis="NAO-VCC-3Z", run_dir="1nn_NAO-VCC-3Z/0.0")
#run_binding_energy_test(pentanol_dimer, embed_mask=embed_mask, hl_calc=calc_hl, ll_calc=calc_ll,hl_xc="PBE0", ll_xc="PBE0", post_hf_method="rpa", basis="NAO-VCC-3Z", run_dir="1nn_NAO-VCC-3Z")
