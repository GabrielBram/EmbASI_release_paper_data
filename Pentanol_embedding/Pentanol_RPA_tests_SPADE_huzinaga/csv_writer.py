...
def run_single_fragment_full_molecule(atoms, hl_calc=calc_hl, ll_calc=calc_ll, hl_xc="pbe", ll_xc="pbe", post_hf_method=None, basis="N/A", run_dir="./Embasi_calc"):
...
def run_binding_energy_test_full_molecule(atoms, hl_calc=calc_hl, ll_calc=calc_ll, hl_xc="pbe", ll_xc="pbe", post_hf_method=None, basis="N/A", run_dir="./Embasi_calc"):
    ...
    for dist_offset in np.arange(-0.5,1.5,0.11):
        ...
        dir_name = os.path.join(run_dir, str(round(dist, ndigits=2)))

        Projection = StandardDFT(atoms, embed_mask=None, calc_base_ll=ll_calc, calc_base_hl=hl_calc, run_dir=dir_name)
        Projection.run()
...
def run_binding_energy_test(atoms, embed_mask=None, hl_calc=calc_hl, ll_calc=calc_ll, hl_xc="pbe", ll_xc="pbe", post_hf_method=None, basis="N/A", run_dir="./EmbASI_calc"):
    ...
    for dist_offset in np.arange(-0.5,1.5,0.11):
        ...
        data_dict = run_single_fragment(atoms, embed_mask=embed_mask, hl_calc=hl_calc, ll_calc=ll_calc, hl_xc=hl_xc, ll_xc=ll_xc, post_hf_method=post_hf_method, basis=basis, run_dir=dir_name)
        data_dict["OH-H Distance"] = dist
...
def run_single_fragment(atoms, embed_mask=None, hl_calc=calc_hl, ll_calc=calc_ll, hl_xc="pbe", ll_xc="pbe", post_hf_method=None, basis="N/A", run_dir="./EmbASI_calc"):
...
def run_single_fragment_and_print(atoms, embed_mask=None, hl_calc=calc_hl, ll_calc=calc_ll, hl_xc="pbe", ll_xc="pbe", post_hf_method=None, basis="N/A", run_dir="calc"):
